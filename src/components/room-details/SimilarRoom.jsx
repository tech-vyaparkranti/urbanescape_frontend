...
//             try {
//                 setLoading(true);
//                 const response = await axios.get('http://192.168.1.13:8000/api/get-room');
                
//                 // Check if response has data and rooms property
//                 if (response.data && response.data.rooms) {
//                     setRooms(response.data.rooms);
//                     console.log("similar room data =================>", response.data.rooms);
//                 } else {
...
//     // Function to parse the images JSON string
